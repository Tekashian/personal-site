          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-gray-300 leading-relaxed">
                <p className="text-lg">
                  I&apos;m a <span className="text-blue-400 font-semibold">Blockchain Architect & Full-Stack Developer</span> with over <span className="text-purple-400 font-semibold">3 years of experience</span> building production-grade decentralized applications, AI-powered automation systems, and high-performance trading infrastructure.
                </p>
                <p>
                  My expertise spans <span className="text-emerald-400 font-semibold">blockchain architecture</span> and <span className="text-fuchsia-400 font-semibold">AI/ML integration</span>. I&apos;ve architected <span className="font-semibold text-teal-400">PolyFund</span> — a decentralized crowdfunding platform with modular smart contracts featuring role-based governance, transparent voting mechanisms, and advanced refund systems. Developed with <span className="text-yellow-400 font-semibold">Hardhat</span>, it showcases my approach to building secure, auditable DeFi platforms following OpenZeppelin standards.
                </p>
                <p>
                  In the <span className="text-purple-400 font-semibold">AI/automation space</span>, I&apos;ve built intelligent systems like <span className="font-semibold text-pink-400">Office AI Agent</span> using <span className="text-violet-400 font-semibold">Google Gemini 2.5</span> for context-aware task automation, email management, and document generation, and <span className="font-semibold text-indigo-400">AI Searcher</span> — a research agent leveraging RAG architecture with ChromaDB vector storage and automated PDF report generation.
                </p>
                <p>
                  I specialize in <span className="text-cyan-400 font-semibold">multi-chain development</span> (Ethereum & Solana), having built on-chain analytics tools that monitor wallet addresses and track transactions in real-time. My trading systems experience includes developing <span className="text-orange-400 font-semibold">high-frequency bots for Binance</span> using FIX API with Go, achieving microsecond-latency order execution and real-time market data processing.
                </p>
                <p>
                  Beyond blockchain and AI, I craft exceptional user experiences with modern frameworks — <span className="text-pink-400 font-semibold">Next.js 15</span>, <span className="text-green-400 font-semibold">React</span>, and <span className="text-blue-400 font-semibold">Vue 3</span> — implementing advanced animations with Framer Motion, GSAP, and custom parallax effects. I believe in writing clean, <span className="text-sky-400 font-semibold">type-safe TypeScript code</span> and building scalable systems with production-grade architecture.
                </p>
              </div>
